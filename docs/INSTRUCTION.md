...
ระบบทำความสะอาด และตรวจสอบข้อมูลอัตโนมัติก่อนการ extract:

**ฟีเจอร์:**
- ✅ Fill missing values ในตาราง metadata
- ✅ ตรวจสอบไฟล์ PDF (ไม่เสีย, มีหน้า, ขนาดเหมาะสม)
- ✅ Normalize ข้อความ (เอาช่องว่างเกิน, control characters)
- ✅ Normalize ตัวเลข (เอา comma, "บาท" ออก)
- ✅ Normalize วันที่ (แปลง พ.ศ. → ค.ศ.)

**ปิด Imputation:**
```bash
python main.py --mode test --skip-imputation
```
